...
export default function OurCenter() {
  ...
  return (
    ...
    <div className='w-full py-16 px-4 bg-white'>
      <h1 className='mx-auto text-bold text-[#00df9a] text-center pb-10 md:text-4xl sm:text-3xl text-2xl'>Our Centers</h1>
    ...
    <div className="mapouter w-full py-16 px-4">
      <div className="gmap_canvas max-w-[1240px] mx-auto">
        <iframe className='w-[100%] h-[350px]' id="gmap_canvas" src="https://maps.google.com/maps?q=redbus%20booking&t=&z=5&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
        </div>
        </div>
    </>
  )

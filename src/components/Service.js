       ...
       <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
            ...
            <a className='font-medium mx-auto text-black' href='https://pratiksingh27.github.io/traveladvice/' target="_blank" rel="noreferrer">
              <button className='text-center bg-[#B00E15] w-[200px] rounded-md font-medium my-4 py-1 mx-auto text-white'>Explore</button>
              </a>
          </div>
          ...
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
            ...
            <a className='font-medium mx-auto text-black' href='https://pratiksingh27.github.io/traveladvice/' target="_blank" rel="noreferrer">
              <button className='text-center bg-[#B00E15] w-[200px] rounded-md font-medium my-4 py-1 mx-auto text-white hover:opacity-80'>Explore</button>
              </a>
          </div>
       </div>
    </div>

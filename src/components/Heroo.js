  ...
  return (
    <div className='text-white'>
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto flex text-center flex-col justify-center'>
        ...
        <button className='bg-[#B00E15] w-[200px] rounded-md font-medium my-4 mx-auto py-1 text-black hover:opacity-70 hover:scale-105 duration-300'><Link to='/registration'>Register Now</Link></button>
      </div>

...
export default function NewsLetter() {
  ...
  return (
    <div className='w-full pt-16 text-white px-4 my-auto'>
      ...
      <div className='my-4 px-4' > 
        <div className='flex flex-col sm:flex-row items-center justify-between w-full mx-auto '>
            <input className='p-2 flex w-full rounded-md text-black mr-2' type="email" name='user_email' placeholder='Enter Email' required/>
